...
<%String loginName=session.getAttribute("loginName").toString();
  //注意在此处的错误写法
  // String loginTime=request.getSession.getAttribute("loginTime").toString();
...
<body class="PageBody" style="margin: 0">
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">HRMS人力资源管理系统</font> 
			<!--<img border="0" src="style/blue/images/logo.png" />-->
        </div>
		
		<div id="Head1Right">
			<div id="Head1Right_UserName">
                <img border="0" width="13" height="14" src="style/images/top/user.gif" /> 您好，<b><%=loginName %></b>
			</div>
        ...
        <div id="Head2_Awoke">
            <ul id="AwokeNum">
                ...
                <li><a href="Flow_Formflow/myTaskList.html" target="desktop">
                		...
                		欢迎您！（<span id="wait" class="taskListSize">1</span>）
                	</a>
                </li>
