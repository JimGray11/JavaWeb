...
<form action="/HRMSystem2.6/addServlet?actionCode=addcategory" method="post">
  ...
  <tbody>
    ...
    <tr style="border:1px solid #98bf21;  text-align:center">
      <td><input type="text" name="id" onblur="fun1()" /></td>
      <td><input type="text" name="name" onblur="fun2()" /></td>
      <td><input type="text" name="description" onblur="fun3()" /></td>
