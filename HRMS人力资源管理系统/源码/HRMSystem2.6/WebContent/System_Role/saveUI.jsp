...
<!--显示表单内容-->
<div id="MainArea">
    <form action="ShowPositionControl?type=createPost" method="post">
        ...
        <div id="InputDetailBar">
            ...
            <a href="ShowPositionControl"><img src="${pageContext.request.contextPath}/style/images/goBack.png"/></a>
        </div>
    </form>
</div>
