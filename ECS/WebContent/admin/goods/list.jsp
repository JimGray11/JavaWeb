...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addGoods(){
				window.location.href = "${pageContext.request.contextPath}/manageGoods_add.action";
			}
		</script>
	</HEAD>
	<body>
				...
				<TBODY>
					...
					<tr>
						<td class="ta_01" align="right">
							<button type="button" id="add" name="add" value="添加" class="button_add" onclick="addGoods()">
&#28155;&#21152;
</button>
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<td width="7%" align="center">
									  ...
									  <c:forEach items="${pageBean.list}" var="g" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand;  HEIGHT: 40px" align="center"
												width="17%">
												<img width="100" height="60" src="${ pageContext.request.contextPath }/${g.image}">
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												${g.name}
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/manageGoods_edit.action?goods.gid=${g.gid}">
													<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/manageGoods_delete.action?goods.gid=${g.gid}">
