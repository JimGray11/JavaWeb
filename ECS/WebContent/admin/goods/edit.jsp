...
<HTML>
	...
	<body>
		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/manageGoods_update.action" method="post" enctype="multipart/form-data">
			&nbsp;
			<table cellspacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr style="height: 60px; width: 100%;">
					...
					<td class="ta_01" bgColor="#ffffff">
					  <input style="display: none;" value="${goods.gid}"  name="goods.gid"/>
						<input type="text" name="goods.name"  value="${goods.name}"   id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						是否热门：
					</td>
				...
				<tr style="height: 40px; width: 100%;">
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="goods.marketPrice" value="${goods.marketPrice}" id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商城价格：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="goods.price" value="${goods.price}"  id="userAction_save_do_logonName" class="bg"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<textarea name="goods.description" rows="5" cols="30">${goods.description}</textarea>
					</td>
				</tr>
				<tr>
